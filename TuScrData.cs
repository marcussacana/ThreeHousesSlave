...
namespace ThreeHousesSlave
{
    internal class TuScrData
    {
        ...
        {
            public uint TableCount;//Should be 2
        ...
        public string[] ReadLanguage(byte[] Data)
        {
            ...
            if (LanguageHeader.TableCount != 2)
